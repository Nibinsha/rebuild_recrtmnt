...
class Candidate(models.Model):
	...
	licence_id = models.CharField(max_length=25,null=True, blank=True)
	...
	intervew_company = models.ForeignKey(ClientMaster, on_delete=models.SET_NULL, null=True, blank=True)
	scheduled_on = models.DateField(blank=True, null=True)
	duration_in_min = models.CharField(max_length=50,null=True, blank=True)
